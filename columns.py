...
def get_column_names_and_positions():
    return get_sno_pos(),get_sno_column_name(),get_issue_key_pos(),get_issue_key_col_name(),get_issue_id_pos(), get_issue_id_col_name(), get_custom_field_epiclink_pos(), get_custom_field_epiclink_col_name(), get_ename_pos(), get_ename_col_name(), get_assignee_pos(), get_assignee_col_name(), get_custom_field_storypoints_pos(), get_custom_field_storypoints_col_name(), get_teste_pos(), get_teste_col_name(), get_original_estimate_pos(), get_original_estimate_col_name(), get_time_spent_pos(), get_time_spent_col_name(), get_remaining_estimate_pos(), get_remaining_estimate_col_name(), get_sprint_pos(), get_sprint_col_name(), get_sprint2_pos(), get_sprint2_col_name(), get_sprint3_pos(), get_sprint3_col_name(), get_summary_pos(), get_summary_col_name(), get_epics_custom_field_pos(), get_epics_Esdate_pos(), get_epics_Etdate_pos(), get_epics_EASdate_pos(), get_epics_EAEdate_pos(), get_progress_pos(), get_progress_gen_column_name(), get_scheduled_progress_pos(), get_scheduled_progress_gen_column_name(), get_scheduled_overrun_pos(), get_scheduled_overrun_gen_column_name(), get_remarks_pos(), get_remarks_gen_column_name()
